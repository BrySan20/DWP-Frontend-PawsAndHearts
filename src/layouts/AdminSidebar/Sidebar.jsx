...
const Sidebar = () => {
  ...
  return (
    <Box className="sidebar-container">
      ...
      <Button startIcon={<Pets />} className="sidebar-button" onClick={() => navigate("/scheduled")}>Scheduled adoptions</Button>
      <Button startIcon={<Pets />} className="sidebar-button" onClick={() => navigate("/completed")}>Completed adoptions</Button>
    </Box>
  );
};
